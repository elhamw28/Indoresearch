            ...
            <div class="row">
                ...
                <div class="col-lg-8 entries">
                    ...
                    <article class="entry entry-single">
                        ...
                        <div class="entry-img">
                            <img src="<?= base_url('') ?>/assets/img/portfolio/startup.jpg" alt="" class="img-fluid">
                        </div>

                        <h2 class="entry-title" style=" color: #80c31b">
                            TIPS MARKETING UNTUK MENGEMBANGKAN STARTUP
                        </h2>

                        <div class="entry-content">
                            <h3>1. Peogram referral</h3>
                            <p style="text-align: justify; text-indent: 45px;"> Laporan Forbes tahun 2019 menyebut 78%
                                pemasar B2B menganggap program rujukan atau
                                referral memiliki prospek yang baik. Pelanggan yang diperoleh melalui rujukan memiliki
                                tingkat retensi 37% lebih tinggi.
                            </p>

                            <h3>2. Gunakan Video</h3>
                            <p style="text-align: justify; text-indent: 45px;"> Sebanyak 78% perusahaan mendapat traffic
                                lebih banyak ketika mereka menyebutkan video
                                atau animasi dalam laham website

                            </p>
                            <h3>3. Program Offline</h3>
                            <p style="text-align: justify; text-indent: 45px;"> Meskipun saat ini banyak perusahaan yang
                                menggunakan pemasaran digital, namun kita tidak
                                boleh mengabaikan pemasaran secara offline, karena pemasaran secara offline juga masih
                                bisa dilakukan misalnya dengan menggunakan browser.

                            </p>

                            <h3>4. Manfaatkan Email</h3>
                            <p style="text-align: justify; text-indent: 45px;"> Sekitar 89% pemasar menggunakan email
                                sebagai salah satu alat utama mereka untuk
                                menghasilkan prospek ke situs web mereka pada tahun 2021. Melalui email, pelanggan baru
                                dan lama bisa mendapat pemberitahuan tentang produk terbaru perusahaan Anda.
                            </p>
                            <p style="text-align: justify; text-indent: 45px;">Namun pastikan bahwa email yang Anda
                                kirim terasa personal, agar menjadi poin plus bagi
                                pelanggan. </p>
