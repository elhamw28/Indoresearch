            ...
            <div class="row">
                ...
                <div class="col-lg-8 entries">
                    ...
                    <article class="entry entry-single">
                        ...
                        <div class="entry-img">
                            <img src="<?= base_url('') ?>/assets/img/portfolio/research.jpg" alt="" class="img-fluid">
                        </div>
                        ...
                        <div class="entry-content">
                            <h3>1. Kuesioner</h3>
                            <p style="text-align: justify; text-indent: 45px;"> Metode ini dilakukan dengan menggunakan
                                formulir yang berisi daftar pertanyaan yang akan
                                diajukan
                            </p>

                            <h3>2. Reset Grup</h3>
                            <p style="text-align: justify; text-indent: 45px;"> Reset Grup dilakukan dengan diskusi
                                kelompok yang memiliki motivasi sama terhadap suatu
                                hal.

                            </p>
                            <h3>3. Survey</h3>
                            <p style="text-align: justify; text-indent: 45px;"> Metode ini biasanya dilakukan secara
                                acak karena bertujuan untuk mendapat gambaran umum
                                yang berkaitan dengan bisnis Anda.

                            </p>

                            <h3>4. Observasi</h3>
                            <p style="text-align: justify; text-indent: 45px;"> Anda dapat melakukan pengamatan secara
                                langsung terhadap situasi pasar melalui media
                                social atau mengamati suatu peristiwa dan dilakukan analisis sebab-akibat.
                            </p>
                        </div>
