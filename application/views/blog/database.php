            ...
            <div class="row">
                ...
                <div class="col-lg-8 entries">
                    ...
                    <article class="entry entry-single">
                        ...
                        <div class="entry-img">
                            <img src="<?= base_url('') ?>/assets/img/portfolio/database.jpg" alt="" class="img-fluid">
                        </div>

                        <h2 class="entry-title" style=" color: #80c31b">
                            4 METODE UMUM DALAM MARKET RESEARCH
                        </h2>
                        <p style="text-align: justify; text-indent: 45px;"> Pelanggan adalah salah satu <strong>aset
                                terbesar perusahaan.</strong> Semakin banyak
                            pelanggan yang setia sama produk, semakin baik biasnisnya. Maka dari itu, sangat penting
                            buat ngebikin database pelanggan di perusahaan. Ketika Anda mau <strong>mempromosikan produk
                                (terutama produk baru), database pelanggan membantu anda.</strong>
                        </p>

                        <div class="entry-content">
                            <h3>1. Giveaways</h3>
                            <p style="text-align: justify; text-indent: 45px;"> banyak perusahaan membuat kontes buat
                                ngumpulin alamat email dengan sukses besar.
                            </p>

                            <h3>2. Webinar</h3>
                            <p style="text-align: justify; text-indent: 45px;"> webinar adalah cara interaktif dan
                                informatif buat memuaskan keinginan serta
                                mengumpulkan info dalam prosesnya.

                            </p>
                            <h3>3. Menampilkan Formulir Opt In (Ikut Serta) Di Situs web</h3>
                            <p style="text-align: justify; text-indent: 45px;"> Kalau Anda mengunjungi sebuah situs web,
                                pasti Anda melihat kotak kecil dengan formulir
                                buat memasukkan alamat email. Nah itulah yang dimaksud dengan "keikutsertaan", biasanya
                                hal ini disampaikan dengan informasi dapatkan ebook gratis.

                            </p>

                            <h3>4. Melalui Survei</h3>
                            <p style="text-align: justify; text-indent: 45px;"> Servei adalah salah satu cara untuk
                                mendapatkan informasi dari pelanggan. Anda dapat
                                menggunakannya untuk mengumpulkan data kuantitatif atau kualitatif atau bisa juga
                                keduanya.
                            </p>
                        </div>
                    ...
                    <div class="blog-author d-flex align-items-center">
                        <img src="<?= base_url('') ?>/assets/img/blog/blog-author.jpg" class="rounded-circle float-left"
                            alt="">
                        <div>
                            <h4>Jane Smith</h4>
                    ...
                    <div class="blog-comments">
                        ...
                        <div id="comment-1" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="<?= base_url('') ?>/assets/img/blog/comments-1.jpg"
                                        alt=""></div>
                                <div>
                        ...
                        <div id="comment-2" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="<?= base_url('') ?>/assets/img/blog/comments-2.jpg"
                                        alt=""></div>
                                <div>
                            ...
                            <div id="comment-reply-1" class="comment comment-reply">
                                <div class="d-flex">
                                    <div class="comment-img"><img
                                            src="<?= base_url('') ?>/assets/img/blog/comments-3.jpg" alt=""></div>
                                    <div>
                                        ...
                                        <p>
                                            ...
                                            aspernatur
                                            ut vitae quia mollitia id non. Qui ad quas nostrum rerum sed necessitatibus
                                            aut
                                            est. Eum officiis sed repellat maxime vero nisi natus. Amet nesciunt
                                            nesciunt
                                ...
                                <div id="comment-reply-2" class="comment comment-reply">
                                    <div class="d-flex">
                                        <div class="comment-img"><img
                                                src="<?= base_url('') ?>/assets/img/blog/comments-4.jpg" alt=""></div>
                                        <div>
                                            ...
                                            <p>
                                                ...
                                                dolores
                                                cupiditate et. Ut unde qui eligendi sapiente omnis ullam. Placeat porro
                                                est
                        ...
                        <div id="comment-3" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="<?= base_url('') ?>/assets/img/blog/comments-5.jpg"
                                        alt=""></div>
                                <div>
                        ...
                        <div id="comment-4" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="<?= base_url('') ?>/assets/img/blog/comments-6.jpg"
                                        alt=""></div>
                                <div>
