            ...
            <div class="row">
                ...
                <div class="col-lg-8 entries">
                    ...
                    <article class="entry entry-single">
                        ...
                        <div class="entry-img">
                            <img src="<?= base_url('') ?>/assets/img/portfolio/jenis data.jpg" alt="" class="img-fluid">
                        </div>
                        ...
                        <div class="entry-content">
                            ...
                            <p style="text-align: justify; text-indent: 45px;">
                                Jenis data yangdikumpulkan dan diperoleh secara langsung dengan melakukan pengamatan
                                atau penelitian untuk memperoleh data. salah satunya adalah melakukan
                                <strong style="color: #FF0000;">survey.</strong>
                            </p>

                            <h3>Data Sekunder</h3>
                            <p style="text-align: justify; text-indent: 45px;"> Jenis data yang dikumpulkan data dan
                                diperoleh secara tidak langsung dari berbagai
                                sumber yang sudah ada sebelumnya. Salah satu cara memperoleh data sekunder adalah dengan
                                melakukan <strong style="color: #FF0000;">desk research.</strong>
