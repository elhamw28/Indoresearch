            ...
            <div class="row">
                ...
                <div class="col-lg-8 entries">
                    ...
                    <article class="entry entry-single">
                        ...
                        <div class="entry-img">
                            <img src="<?= base_url('') ?>/assets/img/portfolio/relationships.jpg" alt=""
                                class="img-fluid">
                        </div>

                        <h2 class="entry-title" style=" color: #80c31b">
                            PENTINGYA MENETUKAN SEGMENTASI DAN TARGET PASAR UNTUK BISNIS
                        </h2>
                        <p style="text-align: justify; text-indent: 45px;">Strategi pemasaran yang dilakukan dengan cara
                            membangun kedekatan dengan pelanggan atau
                            audience. Biasanya perusahaan akan memberikan kepuasan kepada pelanggan secara jangka
                            panjang. Cara yang tepat untuk melakukannya yaitu dengan meningkatkan kualitas ataupun
                    ...
                    <div class="blog-comments">
                        ...
                        <div id="comment-3" class="comment">
                            ...
                            <div id="comment-4" class="comment">
                                <div class="d-flex">
                                    <div class="comment-img"><img
                                            src="<?= base_url('') ?>/assets/img/blog/comments-6.jpg" alt=""></div>
                                    <div>
