...
<head>
    ...
    <!-- Favicons -->
    <link href="<?= base_url() ?>/assets/img/i.png" rel="icon" style="width:0,05px; height:0,05px;">
    <link href="<?= base_url() ?>/assets/img/i.png" rel="apple-touch-icon">
    ...
    <header id="header" class="header fixed-top">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <a href="<?= base_url('home'); ?>" class="logo d-flex align-items-center">
                <img src="<?= base_url() ?>/assets/img/indo.png" alt="">
            </a>

            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="nav-link scrollto" href="<?= base_url('home') ?>">Home</a></li>
                    <li><a class="nav-link scrollto" href="<?= base_url('home/berita') ?>">Artikel</a></li>
                    ...
                    <li><a class="nav-link scrollto" href="<?= base_url('home/Network') ?>">Our Network</a></li>
                    <li><a class="nav-link scrollto" href="<?= base_url('home/team') ?>">Team</a></li>
                    <li><a class="nav-link scrollto" href="<?= base_url('home/client') ?>">Client</a></li>
